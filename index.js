...
console.log(createMenuItem('Taco', 6, 'Lunch'));
console.log(createMenuItem('Milk shake', 5, 'Ice cream'));
...
*/
reviews.push({name: "Moe", rating: 4, feedback:"Amazing place with alot of options"});
console.log(reviews);
...
*/
reviews[7]['feedback'] = "My name is Reyna and this is an amazing place!";
...
function getLastReview(array) {
  const myobj = array[array.length - 1];
  return `${myobj.name} gave the restaurant a ${myobj.rating} star review, and their feedback was: ${myobj.feedback}`
} 
